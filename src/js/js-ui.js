...
UI.Calendar = function(HtmlElement) {
    ...
    function Design(data) {
       ...
       function Header(){
              var panelDafult = document.createElement('div');
              panelDafult.className = 'panel panel-default'
              var panelBobdy = document.createElement('div');
              panelBobdy.className = 'panel-body';
              ...
              panelBobdy.appendChild(row);
              panelDafult.appendChild(panelBobdy);
        }
    }
